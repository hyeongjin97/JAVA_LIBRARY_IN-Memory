...
public class MyPageView extends Login  {
	...
	public void MyPage(Map<String, Member> map, String str,List<UserRecentBook> list) {
	...
	public void modifyNameUtil(Map<String, Member> map, String str,List<UserRecentBook> list) {
	...
	public void modifyPasswordUtil(Map<String, Member> map, String str,List<UserRecentBook> list) {
