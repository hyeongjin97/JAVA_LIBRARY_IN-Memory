...
public class MyPageView extends Login {
	...
	public void MyPage(Map<String, Member> map, String str) {
		System.out.println("원하시는 메뉴를 선택하세요");
		System.out.println("1.정보 수정 2.현재 대여중인 책 3.메인 페이지로 가기");
		num = sc.nextLine();
		switch (num) {
		case "1":
			modifyInfoPage(map, str);
			break;
		case "2":
			break;
		case "3":
	...
	public void modifyInfoPage(Map<String, Member> map, String str) {
		...
		switch (num) {
		case "1":
			modifyNameUtil(map, str);
			break;
		case "2":
			modifyPasswordUtil(map, str);
			break;
		case "3":
			break;
		case "4":
	...
	public void modifyNameUtil(Map<String, Member> map, String str) {
	...
	public void modifyPasswordUtil(Map<String, Member> map, String str) {
